...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="number" min="0" max="99999999999" placeholder="Enter your phone number" required onkeypress="if(this.value.length == 10) return false;" class="box">
